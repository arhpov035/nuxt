<template>
  <div class="page-product">
    ...
    <section class="products">
      <div class="product-item box-shadow" v-for="product of allProducts" :key="product.id">
    ...
    <Button class="btn yelow" :action="fetchProducts" :btnValue="'Загрузить ещё'"/>
  </div>
</template>
...
export default {
  ...
  head() {
    return {
      title: this.title,
      meta: [
        { hid: 'description', name: 'description', content: 'Самый лучший сайт о тортах и не только' },
      ]
    }
  },
  data() {
